...
class Eon():
        ...
        try:
            ...
            memory.write('''[
                                ["Éon"],
                                {
                                    ...
                                    "bem": "Que bom!",
                                    "mais ou menos": "Quer conversar sobre isso?",
                                    "mal": "Pouxa, o que aconteceu?",
                                    "bem mal": "Nossa, o que aconteceu? Quer conversar sobre isso?"
                                }
                            ]''')
            memory.close()
            memory = open(name+'.json', 'r')
    ...
    def think(self, phrase):
        ...
        if "bem mal" in phrase:
            return self.phrases["bem mal"]
        else:
            for tag in self.phrases:
                if "bem mal" not in tag:
                    if tag in phrase:
                        return self.phrases[tag]
